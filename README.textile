...
Existem disponiveis diversas bibliotecas ORM. Nós utilizamos as que já existem e oque para nós atendem a todas as nossas necessidades. Poderá ter uma lista das diversas bibliotecas em:
